...
$(function(){$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(this).parent().parent().next().find(".main-mnu").slideToggle(),!1}),$(".main-footer .toggle-mnu").click(function(){return $("html, body").animate({scrollTop:$(document).height()},"slow"),!1}),$(".arrow-bottom").click(function(){return $("html, body").animate({scrollTop:$(".main-head").height()+150},"slow"),!1}),$(".top").click(function(){return $("html, body").animate({scrollTop:0},"slow"),!1}),$(".section-head h2, .section-head p").animated("fadeIn"),$(".s2-items .s2-item").animated("fadeIn"),$(".section-content .info-item, .s1-bottom .info-item").animated("zoomIn"),$(".homesect.section_8 .forms").animated("fadeInRight"),$(".homesect.section_8 .s8-item").animated("fadeInLeft"),$(".homesect.section_8 .p").animated("fadeIn"),$(".section-content .info-item").equalHeights(),$(".s1-bottom .info-item").equalHeights(),$(".s2-items .s2-item>span").equalHeights(),$(".section_4").waypoint(function(){$(".section_4 .card").each(function(t){var e=$(this);setInterval(function(){e.removeClass("card-off").addClass("card-on")},150*t)}),this.destroy()},{offset:"20%"}),$(".section_5").waypoint(function(){$(".section_5 .tc-item").each(function(t){var e=$(this);setTimeout(function(){new DrawFillSVG({elementId:"tc-svg-"+t});e.removeClass(".tc-content").addClass(".tc-content-on")},700*t)}),this.destroy()},{offset:"80%"}),$(".section_6").waypoint(function(){$(".section_6 .team").each(function(t){var e=$(this);setInterval(function(){e.removeClass("team-off").addClass("team-on")},200*t)}),this.destroy()},{offset:"20%"}),$(".slider").owlCarousel({items:1,loop:!0,nav:!0,navText:"",dotsSpeed:600,fluidSpeed:600,autoplaySpeed:600,navSpeed:600,dragEndSpeed:600}),$(".homesect .section-bottom .buttons").click(function(){$("#callback h4").html($(this).text()),$("#callback input[name=formname]").val($(this).text())}).magnificPopup({type:"inline",mainClass:"mfp-forms"}),$(".forms").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){alert("Спасибо за заявку!"),setTimeout(function(){$.magnificPopup.close(),$(".forms").trigger("reset")},1e3)}),!1});try{$.browserSelector(),$("html").hasClass("chrome")&&$.smoothScroll()}catch(t){}}),$(window).on("load",function(){$("body").css("opacity","1")});